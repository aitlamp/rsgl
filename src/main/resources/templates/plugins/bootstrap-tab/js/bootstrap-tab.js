...
(function ($, window, document, undefined) {
    ...
    BaseTab.prototype.template = {
        ...
        div_content_panel: '<div role="tabpanel" class="tab-pane" id="{0}"> ' +
        '   <iframe id="iframe_\'+id+\'" src="\' + options.url + \'" width="100%" height="100%" ' +
        '       onload="changeFrameHeight(this)" frameborder="no" border="0" marginwidth="0" ' +
